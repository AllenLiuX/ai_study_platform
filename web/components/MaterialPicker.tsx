...
export function MaterialPicker({
  ...
  const myMaterials = ready.filter((m) => m.owner_type === "student");
  const platformMaterials = ready.filter((m) => m.owner_type === "platform");
  ...
  return (
    <div className="space-y-2">
      ...
      {open && (
        <div className="max-h-72 overflow-y-auto rounded-xl border border-border bg-card p-2 shadow-card scrollbar-thin">
...
function PickerSection({
  ...
  return (
    <div className="mt-1.5 first:mt-0">
      <div className="mb-1 flex items-center gap-1 px-1.5 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
        {isPlatform && <Sparkles className="h-2.5 w-2.5 text-primary" />}
        <span>{title}</span>
